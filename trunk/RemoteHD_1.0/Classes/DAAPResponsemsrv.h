...
@property (retain, nonatomic) NSNumber  *aeSV;
@property (retain, nonatomic) NSNumber  *aeFP;
@property (retain, nonatomic) NSNumber  *ated;
@property (retain, nonatomic) NSNumber  *msed;
@property (retain, nonatomic) NSNumber  *msml;
@property (retain, nonatomic) NSString  *ceWM;
@property (retain, nonatomic) NSNumber  *ceVO;
