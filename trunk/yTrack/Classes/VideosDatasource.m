...
@implementation VideosDatasource
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([mlit.name isEqualToString:CurrentServer.currentTrack] && [mlit.artistName isEqualToString:CurrentServer.currentArtist]){
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    DAAPResponsemlit *track = (DAAPResponsemlit *)[self.list objectAtIndex:i];
    [CurrentServer playVideo: [track.miid longValue]];
